...
public class KafkaConsumerConfig {
     ...
     */
    @Bean
    public ConsumerFactory<String, TransactionAcceptedDto> kafkaTransactionRequestedDtoConsumerFactory() {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, TransactionAcceptedDto> kafkaTransactionAcceptedMessageDtoListenerContainerFactory() {
        return kafkaListenerContainerFactory(kafkaTransactionRequestedDtoConsumerFactory());
    }
}