...
public class LogAspect {
    ...
    @Pointcut("within(ru.t1.java.base.*)")
    public void loggingMethods() {

    }

    @Before("@annotation(ru.t1.java.base.aop.LogExecution)")
    @Order(1)
...
//    }
    ...
    @AfterThrowing(pointcut = "@annotation(ru.t1.java.base.aop.LogException)")
    @Order(0)
    ...
    @AfterReturning(
            pointcut = "@annotation(ru.t1.java.base.aop.HandlingResult)",
            returning = "result")
