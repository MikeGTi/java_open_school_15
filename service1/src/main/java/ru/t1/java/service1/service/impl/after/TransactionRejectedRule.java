...
@Slf4j
@Component
public class TransactionRejectedRule extends Rule<TransactionResultDto> {

    private final TransactionRepository transactionRepository;
    private final AccountRepository accountRepository;

    public TransactionRejectedRule(TransactionRepository transactionRepository, AccountRepository accountRepository) {
        super(transactionResultDto -> transactionResultDto.getTransactionStatus().equals(TransactionStatus.REJECTED));
